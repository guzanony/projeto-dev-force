...
import br.com.KiloByte.domain.cliente.EnderecoEntrega;
import br.com.KiloByte.domain.cliente.EnderecoEntregaRepository;
import br.com.KiloByte.infra.security.TokenService;
import br.com.KiloByte.dto.EnderecoEntregaDTO;
import br.com.KiloByte.dto.LoginClienteDTO;
import br.com.KiloByte.dto.RegisterClienteDTO;
...
public class ClienteController {
    ...
    public ResponseEntity loginCliente(@RequestBody LoginClienteDTO body) {
        ...
        if(passwordEncoder.matches(body.password(), cliente.getPassword())) {
            ...
            return ResponseEntity.ok(new ResponseDTO(cliente.getEmail(), cliente.getNomeCompleto(), cliente.getBairroFaturamento(), cliente.getId()));
        }
    ...
    public ResponseEntity<?> registerCliente(@RequestBody RegisterClienteDTO body) {
        ...
        return ResponseEntity.ok(new ResponseDTO(newCliente.getEmail(), newCliente.getNomeCompleto(), newCliente.getBairroFaturamento(), newCliente.getId()));
    }
